function Post(props) {
    ...
    const trimmedText = ( 500 < post.content.length ) ? post.content.rendered.substring(0, 450) + "..." : post.content.rendered;

    return (
        <div className="RedditItem card">
            <div className="card-body">
                { post.featured_image_url &&
                    <img src={post.featured_image_url} className="card-img-top" alt={post.title.rendered} />
                }
